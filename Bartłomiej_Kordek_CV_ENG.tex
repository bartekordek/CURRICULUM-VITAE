...
\begin{tabular}{@{}p{0.70\textwidth} r}
	 \begin{minipage}{0.70\textwidth}
		...
		\textbf{Address}:		&	ul. Kaliska 8/10, 02-316 Warszawa\\
...
\end{tabular}
Software Developer\\
Technical Team Lead at Content \& Culturalization Development Department \\
\begin{itemize}
    \item Improvements, development and maintenance of the mobile game ( \texttt{C++}, \texttt{Lua}, \texttt{Bash}, \texttt{Python}, \texttt{Ruby} ).
    \item Creation of various utils to aid development proces
