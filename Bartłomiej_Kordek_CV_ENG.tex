...
\begin{itemize}
	\item Office suite: (\texttt{Microsoft Office}, \texttt{Open Office}, \texttt{Libre Office}) and \texttt{Gnumeric} spreadsheet.
	...
	\item Basic skills in programming in: \texttt{C}, \texttt{C++}, \texttt{C\#}, \texttt{Java}, Linux shell scripts (\texttt{Bash}), \texttt{Labview\texttt} and Python.
	...
	\item Development environments: \texttt{Eclipse}, \texttt{VIM} and MS Visual Studio.
